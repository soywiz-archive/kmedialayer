...
actual class KmlBufferBase private constructor(val nioBuffer: ByteBuffer) : KmlBuffer {
    val byteBuffeer = nioBuffer
    val shortBuffer = nioBuffer.asShortBuffer()
    val intBuffer = nioBuffer.asIntBuffer()
    val floatBuffer = nioBuffer.asFloatBuffer()
...
@Suppress("USELESS_CAST") val KmlBuffer.nioByteBuffer: ByteBuffer get() = (baseBuffer as KmlBufferBase).nioBuffer
@Suppress("USELESS_CAST") val KmlBuffer.nioShortBuffer: ShortBuffer get() = (baseBuffer as KmlBufferBase).shortBuffer
@Suppress("USELESS_CAST") val KmlBuffer.nioIntBuffer: IntBuffer get() = (baseBuffer as KmlBufferBase).intBuffer
@Suppress("USELESS_CAST") val KmlBuffer.nioFloatBuffer: FloatBuffer get() = (baseBuffer as KmlBufferBase).floatBuffer
