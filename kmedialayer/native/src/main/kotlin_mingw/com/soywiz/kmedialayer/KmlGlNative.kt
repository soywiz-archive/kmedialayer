...
class KmlGlNative : KmlGl() {
    ...
    override fun bindAttribLocation(program: Int, index: Int, name: String): Unit = glBindAttribLocation(program, index, (name).glstr)
    ...
    override fun bufferData(target: Int, size: Int, data: KmlBuffer, usage: Int): Unit = glBufferData(target, size.narrowSize(), data.unsafeAddress().uncheckedCast(), usage)
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: KmlBuffer): Unit = glBufferSubData(target, offset.narrowSize(), size.narrowSize(), data.unsafeAddress().uncheckedCast())
    ...
    override fun compressedTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, imageSize: Int, data: KmlBuffer): Unit = glCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data.unsafeAddress().uncheckedCast())
    override fun compressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, imageSize: Int, data: KmlBuffer): Unit = glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data.unsafeAddress().uncheckedCast())
    ...
    override fun deleteBuffers(n: Int, items: KmlBuffer): Unit = glDeleteBuffers(n, items.unsafeAddress().uncheckedCast())
    override fun deleteFramebuffers(n: Int, items: KmlBuffer): Unit = glDeleteFramebuffers(n, items.unsafeAddress().uncheckedCast())
    override fun deleteProgram(program: Int): Unit = glDeleteProgram(program)
    override fun deleteRenderbuffers(n: Int, items: KmlBuffer): Unit = glDeleteRenderbuffers(n, items.unsafeAddress().uncheckedCast())
    ...
    override fun genBuffers(n: Int, buffers: KmlBuffer): Unit = glGenBuffers(n, buffers.unsafeAddress().uncheckedCast())
    override fun generateMipmap(target: Int): Unit = glGenerateMipmap(target)
    override fun genFramebuffers(n: Int, framebuffers: KmlBuffer): Unit = glGenFramebuffers(n, framebuffers.unsafeAddress().uncheckedCast())
    override fun genRenderbuffers(n: Int, renderbuffers: KmlBuffer): Unit = glGenRenderbuffers(n, renderbuffers.unsafeAddress().uncheckedCast())
    override fun genTextures(n: Int, textures: KmlBuffer): Unit = glGenTextures(n, textures.unsafeAddress().uncheckedCast())
    ...
    override fun getAttribLocation(program: Int, name: String): Int = glGetAttribLocation(program, (name).glstr)
    override fun getUniformLocation(program: Int, name: String): Int = glGetUniformLocation(program, (name).glstr)
    ...
    override fun getFloatv(pname: Int, data: KmlBuffer): Unit = glGetFloatv(pname, data.unsafeAddress().uncheckedCast())
    override fun getFramebufferAttachmentParameteriv(target: Int, attachment: Int, pname: Int, params: KmlBuffer): Unit = glGetFramebufferAttachmentParameteriv(target, attachment, pname, params.unsafeAddress().uncheckedCast())
    override fun getIntegerv(pname: Int, data: KmlBuffer): Unit = glGetIntegerv(pname, data.unsafeAddress().uncheckedCast())
    override fun getProgramInfoLog(program: Int, bufSize: Int, length: KmlBuffer, infoLog: KmlBuffer): Unit = glGetProgramInfoLog(program, bufSize, length.unsafeAddress().uncheckedCast(), infoLog.unsafeAddress().uncheckedCast())
    override fun getRenderbufferParameteriv(target: Int, pname: Int, params: KmlBuffer): Unit = glGetRenderbufferParameteriv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun getProgramiv(program: Int, pname: Int, params: KmlBuffer): Unit = glGetProgramiv(program, pname, params.unsafeAddress().uncheckedCast())
    override fun getShaderiv(shader: Int, pname: Int, params: KmlBuffer): Unit = glGetShaderiv(shader, pname, params.unsafeAddress().uncheckedCast())
    override fun getShaderInfoLog(shader: Int, bufSize: Int, length: KmlBuffer, infoLog: KmlBuffer): Unit = glGetShaderInfoLog(shader, bufSize, length.unsafeAddress().uncheckedCast(), infoLog.unsafeAddress().uncheckedCast())
    override fun getShaderPrecisionFormat(shadertype: Int, precisiontype: Int, range: KmlBuffer, precision: KmlBuffer): Unit = Unit
    override fun getShaderSource(shader: Int, bufSize: Int, length: KmlBuffer, source: KmlBuffer): Unit = glGetShaderSource(shader, bufSize, length.unsafeAddress().uncheckedCast(), source.unsafeAddress().uncheckedCast())
    override fun getString(name: Int): String = (glGetString(name))?.toKString() ?: ""
    override fun getTexParameterfv(target: Int, pname: Int, params: KmlBuffer): Unit = glGetTexParameterfv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun getTexParameteriv(target: Int, pname: Int, params: KmlBuffer): Unit = glGetTexParameteriv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun getUniformfv(program: Int, location: Int, params: KmlBuffer): Unit = glGetUniformfv(program, location, params.unsafeAddress().uncheckedCast())
    override fun getUniformiv(program: Int, location: Int, params: KmlBuffer): Unit = glGetUniformiv(program, location, params.unsafeAddress().uncheckedCast())
    override fun getVertexAttribfv(index: Int, pname: Int, params: KmlBuffer): Unit = glGetVertexAttribfv(index, pname, params.unsafeAddress().uncheckedCast())
    override fun getVertexAttribiv(index: Int, pname: Int, params: KmlBuffer): Unit = glGetVertexAttribiv(index, pname, params.unsafeAddress().uncheckedCast())
    override fun getVertexAttribPointerv(index: Int, pname: Int, pointer: KmlBuffer): Unit = glGetVertexAttribPointerv(index, pname, pointer.unsafeAddress().uncheckedCast())
    ...
    override fun readPixels(x: Int, y: Int, width: Int, height: Int, format: Int, type: Int, pixels: KmlBuffer): Unit = glReadPixels(x, y, width, height, format, type, pixels.unsafeAddress().uncheckedCast())
    ...
    override fun texImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: Int, type: Int, pixels: KmlBuffer): Unit = glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels.unsafeAddress().uncheckedCast())
    override fun texImage2D(target: Int, level: Int, internalformat: Int, format: Int, type: Int, data: KmlNativeImageData): Unit = glTexImage2D(target, level, internalformat, data.width, data.height, 0, format, type, (data as KmlNativeNativeImageData).data.unsafeAddress().uncheckedCast())
    override fun texParameterf(target: Int, pname: Int, param: Float): Unit = glTexParameterf(target, pname, param)
    override fun texParameterfv(target: Int, pname: Int, params: KmlBuffer): Unit = glTexParameterfv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun texParameteri(target: Int, pname: Int, param: Int): Unit = glTexParameteri(target, pname, param)
    override fun texParameteriv(target: Int, pname: Int, params: KmlBuffer): Unit = glTexParameteriv(target, pname, params.unsafeAddress().uncheckedCast())
    override fun texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, type: Int, pixels: KmlBuffer): Unit = glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels.unsafeAddress().uncheckedCast())
    override fun uniform1f(location: Int, v0: Float): Unit = glUniform1f(location, v0)
    override fun uniform1fv(location: Int, count: Int, value: KmlBuffer): Unit = glUniform1fv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform1i(location: Int, v0: Int): Unit = glUniform1i(location, v0)
    override fun uniform1iv(location: Int, count: Int, value: KmlBuffer): Unit = glUniform1iv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform2f(location: Int, v0: Float, v1: Float): Unit = glUniform2f(location, v0, v1)
    override fun uniform2fv(location: Int, count: Int, value: KmlBuffer): Unit = glUniform2fv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform2i(location: Int, v0: Int, v1: Int): Unit = glUniform2i(location, v0, v1)
    override fun uniform2iv(location: Int, count: Int, value: KmlBuffer): Unit = glUniform2iv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform3f(location: Int, v0: Float, v1: Float, v2: Float): Unit = glUniform3f(location, v0, v1, v2)
    override fun uniform3fv(location: Int, count: Int, value: KmlBuffer): Unit = glUniform3fv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform3i(location: Int, v0: Int, v1: Int, v2: Int): Unit = glUniform3i(location, v0, v1, v2)
    override fun uniform3iv(location: Int, count: Int, value: KmlBuffer): Unit = glUniform3iv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform4f(location: Int, v0: Float, v1: Float, v2: Float, v3: Float): Unit = glUniform4f(location, v0, v1, v2, v3)
    override fun uniform4fv(location: Int, count: Int, value: KmlBuffer): Unit = glUniform4fv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniform4i(location: Int, v0: Int, v1: Int, v2: Int, v3: Int): Unit = glUniform4i(location, v0, v1, v2, v3)
    override fun uniform4iv(location: Int, count: Int, value: KmlBuffer): Unit = glUniform4iv(location, count, value.unsafeAddress().uncheckedCast())
    override fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: KmlBuffer): Unit = glUniformMatrix2fv(location, count, transpose.narrow(), value.unsafeAddress().uncheckedCast())
    override fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: KmlBuffer): Unit = glUniformMatrix3fv(location, count, transpose.narrow(), value.unsafeAddress().uncheckedCast())
    override fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: KmlBuffer): Unit = glUniformMatrix4fv(location, count, transpose.narrow(), value.unsafeAddress().uncheckedCast())
    ...
    override fun vertexAttrib1fv(index: Int, v: KmlBuffer): Unit = glVertexAttrib1fv(index, v.unsafeAddress().uncheckedCast())
    override fun vertexAttrib2f(index: Int, x: Float, y: Float): Unit = glVertexAttrib2f(index, x, y)
    override fun vertexAttrib2fv(index: Int, v: KmlBuffer): Unit = glVertexAttrib2fv(index, v.unsafeAddress().uncheckedCast())
    override fun vertexAttrib3f(index: Int, x: Float, y: Float, z: Float): Unit = glVertexAttrib3f(index, x, y, z)
    override fun vertexAttrib3fv(index: Int, v: KmlBuffer): Unit = glVertexAttrib3fv(index, v.unsafeAddress().uncheckedCast())
    override fun vertexAttrib4f(index: Int, x: Float, y: Float, z: Float, w: Float): Unit = glVertexAttrib4f(index, x, y, z, w)
    override fun vertexAttrib4fv(index: Int, v: KmlBuffer): Unit = glVertexAttrib4fv(index, v.unsafeAddress().uncheckedCast())
