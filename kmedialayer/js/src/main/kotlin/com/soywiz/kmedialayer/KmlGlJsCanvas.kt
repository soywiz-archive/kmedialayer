...
class KmlGlJsCanvas(val canvas: HTMLCanvasElement) : KmlGl() {
    ...
    override fun bindFramebuffer(target: Int, framebuffer: Int): Unit = gl.bindFramebuffer(target, framebuffer)
    override fun bindRenderbuffer(target: Int, renderbuffer: Int): Unit = gl.bindRenderbuffer(target, renderbuffer)
    ...
    override fun bufferData(target: Int, size: Long, data: KmlBuffer, usage: Int): Unit = gl.bufferData(target, size, data, usage)
    override fun bufferSubData(target: Int, offset: Long, size: Long, data: KmlBuffer): Unit = gl.bufferSubData(target, offset, size, data)
    ...
    override fun compressedTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, imageSize: Int, data: KmlBuffer): Unit = gl.compressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data)
    override fun compressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, imageSize: Int, data: KmlBuffer): Unit = gl.compressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data)
    ...
    override fun deleteBuffers(n: Int, buffers: KmlBuffer): Unit = gl.deleteBuffers(n, buffers)
    override fun deleteFramebuffers(n: Int, framebuffers: KmlBuffer): Unit = gl.deleteFramebuffers(n, framebuffers)
    override fun deleteProgram(program: Int): Unit = gl.deleteProgram(program.get())
    override fun deleteRenderbuffers(n: Int, renderbuffers: KmlBuffer): Unit = gl.deleteRenderbuffers(n, renderbuffers)
    override fun deleteShader(shader: Int): Unit = gl.deleteShader(shader.get())
    override fun deleteTextures(n: Int, textures: KmlBuffer): Unit = gl.deleteTextures(n, textures)
    ...
    override fun drawElements(mode: Int, count: Int, type: Int, indices: KmlBuffer): Unit = gl.drawElements(mode, count, type, indices)
    ...
    override fun framebufferRenderbuffer(target: Int, attachment: Int, renderbuffertarget: Int, renderbuffer: Int): Unit = gl.framebufferRenderbuffer(target, attachment, renderbuffertarget, renderbuffer)
    ...
    override fun genFramebuffers(n: Int, framebuffers: KmlBuffer): Unit = gl.genFramebuffers(n, framebuffers)
    override fun genRenderbuffers(n: Int, renderbuffers: KmlBuffer): Unit = gl.genRenderbuffers(n, renderbuffers)
    override fun genTextures(n: Int, textures: KmlBuffer): Unit = gl.genTextures(n, textures)
    ...
    override fun getString(name: Int): String = gl.getParameter(name) as String
    ...
    override fun getUniformLocation(program: Int, name: String): Int = gl.getUniformLocation(program.get(), name)
    ...
    override fun isFramebuffer(framebuffer: Int): Boolean = gl.isFramebuffer(framebuffer)
    override fun isProgram(program: Int): Boolean = gl.isProgram(program.get())
    override fun isRenderbuffer(renderbuffer: Int): Boolean = gl.isRenderbuffer(renderbuffer)
    ...
    override fun releaseShaderCompiler(): Unit = gl.releaseShaderCompiler()
    ...
    override fun uniform1fv(location: Int, count: Int, value: KmlBuffer): Unit = gl.uniform1fv(location.get(), count, value)
    override fun uniform1i(location: Int, v0: Int): Unit = gl.uniform1i(location.get(), v0)
    override fun uniform1iv(location: Int, count: Int, value: KmlBuffer): Unit = gl.uniform1iv(location.get(), count, value)
    override fun uniform2f(location: Int, v0: Float, v1: Float): Unit = gl.uniform2f(location.get(), v0, v1)
    override fun uniform2fv(location: Int, count: Int, value: KmlBuffer): Unit = gl.uniform2fv(location.get(), count, value)
    override fun uniform2i(location: Int, v0: Int, v1: Int): Unit = gl.uniform2i(location.get(), v0, v1)
    override fun uniform2iv(location: Int, count: Int, value: KmlBuffer): Unit = gl.uniform2iv(location.get(), count, value)
    override fun uniform3f(location: Int, v0: Float, v1: Float, v2: Float): Unit = gl.uniform3f(location.get(), v0, v1, v2)
    override fun uniform3fv(location: Int, count: Int, value: KmlBuffer): Unit = gl.uniform3fv(location.get(), count, value)
    override fun uniform3i(location: Int, v0: Int, v1: Int, v2: Int): Unit = gl.uniform3i(location.get(), v0, v1, v2)
    override fun uniform3iv(location: Int, count: Int, value: KmlBuffer): Unit = gl.uniform3iv(location.get(), count, value)
    override fun uniform4f(location: Int, v0: Float, v1: Float, v2: Float, v3: Float): Unit = gl.uniform4f(location.get(), v0, v1, v2, v3)
    override fun uniform4fv(location: Int, count: Int, value: KmlBuffer): Unit = gl.uniform4fv(location.get(), count, value)
    override fun uniform4i(location: Int, v0: Int, v1: Int, v2: Int, v3: Int): Unit = gl.uniform4i(location.get(), v0, v1, v2, v3)
    override fun uniform4iv(location: Int, count: Int, value: KmlBuffer): Unit = gl.uniform4iv(location.get(), count, value)
    ...
    override fun vertexAttribPointer(index: Int, size: Int, type: Int, normalized: Boolean, stride: Int, pointer: Long): Unit = gl.vertexAttribPointer(index, size, type, normalized, stride, pointer)
