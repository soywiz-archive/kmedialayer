...
class JvmKmlGl : KmlGl() {
    ...
    override fun bufferData(target: Int, size: Int, data: KmlBuffer, usage: Int): Unit = glBufferData(target, size.toLong(), data.nioBuffer, usage)
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: KmlBuffer): Unit = glBufferSubData(target, offset.toLong(), size.toLong(), data.nioBuffer)
    ...
    override fun deleteBuffers(n: Int, items: KmlBuffer): Unit = glDeleteBuffers(n, items.nioBuffer)
    override fun deleteFramebuffers(n: Int, items: KmlBuffer): Unit = glDeleteFramebuffers(n, items.nioBuffer)
    override fun deleteProgram(program: Int): Unit = glDeleteProgram(program)
    override fun deleteRenderbuffers(n: Int, items: KmlBuffer): Unit = glDeleteRenderbuffers(n, items.nioBuffer)
    override fun deleteShader(shader: Int): Unit = glDeleteShader(shader)
    override fun deleteTextures(n: Int, items: KmlBuffer): Unit = glDeleteTextures(n, items.nioBuffer)
