...
object KmlGlGenerate {
    ...
    object OpenglDesc {
        ...
        fun function(rettype: GlType, name: String, vararg args: Pair<String, GlType>) {
            functions[name] = Function(name, rettype, args.map { Argument(it.first, it.second) }.toList())
        }
        ...
        init {
            ...
            functionV("glBufferData", "target" to GlInt, "size" to GlSize, "data" to GlVoidPtr, "usage" to GlInt)
            functionV(
                "glBufferSubData",
                "target" to GlInt,
                "offset" to GlSize,
